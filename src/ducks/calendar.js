...
const GET_CALENDAR_RECORDS_FULFILLED = 'calendar/GET_CALENDAR_RECORDS_FULFILLED';
...
const DELETE_CALENDAR_RECORD_FULFILLED = 'calendar/DELETE_CALENDAR_RECORD_FULFILLED';
const DELETE_CALENDAR_RECORD_REJECTED = 'calendar/DELETE_CALENDAR_RECORD_REJECTED';
...
export const getCalendarRecords = (isRefreshing) => async (dispatch) => {
