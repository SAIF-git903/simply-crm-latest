...
class VendorRecord extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false
    ...
    render() {
        ...
        if (!this.state.loading) {
            return (
                <TouchableOpacity
                    onPress={() => { this.props.onRecordSelect(this.props.item.id, this.props.item.vendorName, this.props.index); }}
                >
                    <View
                    ...
                    >
                        ...
                        {this.renderLabel(this.props.item.vendorEmail)}
                        {this.renderLabel(this.props.item.vendorPhone)}
                        {this.renderLabel(this.props.item.vendorWebsite)}
...
export default connect(null)(VendorRecord);
