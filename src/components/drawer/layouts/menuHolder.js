       ...
       return (
            <TouchableOpacity onPress={this.onButtonPress.bind(this)}>
                <View style={[styles.holder]}>
                    ...
                    {/* <Image style={[styles.image, { tintColor: (this.props.selectedButton !== this.props.module.name) ? DRAWER_MODULE_BUTTON_TEXT_COLOR : DRAWER_MODULE_BUTTON_TEXT_SELECTED_COLOR }]} source={{ uri: (this.props.custom) ? 'custom' : this.props.module.name.toLowerCase() }} /> */}
