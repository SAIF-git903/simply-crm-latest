...
export default function InputField(props) {
    ...
    const { isAddingComment, replyTo, editedComment } = useSelector(state => state.comments)
    ...
    function renderReplyOrEdit() {
        ...
        return <View style={{
            ...
            <TouchableOpacity
                style={{ height: 32, width: 44, justifyContent: 'center', alignItems: 'center' }}
                onPress={() => {
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View style={{ ...styles.inputFieldWrapper }}>
                <TextInput
                    ...
                    autoCorrect={false}
                    autoCapitalize='none'
                    style={{ ...styles.inputField, color: isAddingComment ? 'gray' : 'black' }}
                    value={value}
