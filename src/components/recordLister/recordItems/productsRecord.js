...
class ProductsRecord extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false
    ...
    onDeletePress() {
        Alert.alert('Are you sure want to delete this record ?', this.props.item.productLable,
            [
...
export default connect(null)(ProductsRecord);
